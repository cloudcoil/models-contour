...
Typed contour resources for the Cloudcoil Kubernetes client.

[![PyPI](https://img.shields.io/pypi/v/cloudcoil.models.contour.svg)](https://pypi.org/project/cloudcoil.models.contour/)
...
```sh
uv add cloudcoil.models.contour
# Or:
pip install cloudcoil.models.contour
```
